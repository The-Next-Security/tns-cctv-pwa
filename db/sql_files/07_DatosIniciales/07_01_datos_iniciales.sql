...
INSERT INTO ale_evento (id_evento, id_tenant, id_site, id_fuente, external_event_id, event_type, severity, zone_code, plate, occurred_at, state, critical, priority, payload_version, raw_payload_json, matched_rule_ids_json, decision_reason) VALUES
  ...
  ('EV000000000000000000000006', 'TN000000000000000000000001', 'ST000000000000000000000001', 'SC000000000000000000000008', 'ext-6', 'WanderDetection', 4, 'zone-7', NULL, '2026-06-09 11:40:00.000', 'NEW', 0, 80, '1.0', '{"event_code":"WanderDetection","channel":8,"plate":null}', '["RG000000000000000000000002"]', NULL),
  ('EV000000000000000000000007', 'TN000000000000000000000001', 'ST000000000000000000000001', 'SC000000000000000000000006', 'ext-7', 'VideoBlind', 4, NULL, NULL, '2026-06-09 11:35:00.000', 'NEW', 0, 80, '1.0', '{"event_code":"VideoBlind","channel":6,"plate":null}', '["RG000000000000000000000008"]', NULL),
  ('EV000000000000000000000008', 'TN000000000000000000000001', 'ST000000000000000000000001', 'SC000000000000000000000004', 'ext-8', 'TrafficJunction', 2, 'zone-1', 'BCDF-12', '2026-06-09 11:15:00.000', 'NEW', 0, 40, '1.0', '{"event_code":"TrafficJunction","channel":4,"plate":"BCDF-12"}', '["RG000000000000000000000006"]', NULL),
  ('EV000000000000000000000009', 'TN000000000000000000000001', 'ST000000000000000000000001', 'SC000000000000000000000008', 'ext-9', 'WanderDetection', 4, 'zone-7', NULL, '2026-06-09 10:30:00.000', 'NEW', 0, 80, '1.0', '{"event_code":"WanderDetection","channel":8,"plate":null}', '["RG000000000000000000000002"]', NULL),
  ('EV000000000000000000000010', 'TN000000000000000000000001', 'ST000000000000000000000001', 'SC000000000000000000000001', 'ext-10', 'CrossLineDetection', 5, 'zone-6', NULL, '2026-06-09 07:00:00.000', 'NEW', 1, 100, '1.0', '{"event_code":"CrossLineDetection","channel":1,"plate":null}', '["RG000000000000000000000001"]', NULL),
  ('EV000000000000000000000011', 'TN000000000000000000000001', 'ST000000000000000000000001', 'SC000000000000000000000002', 'ext-11', 'TrafficOverSpeed', 4, NULL, 'KLMN-34', '2026-06-09 05:00:00.000', 'NEW', 0, 80, '1.0', '{"event_code":"TrafficOverSpeed","channel":2,"plate":"KLMN-34"}', '["RG000000000000000000000007"]', NULL),
  ('EV000000000000000000000012', 'TN000000000000000000000001', 'ST000000000000000000000001', 'SC000000000000000000000004', 'ext-12', 'CrossRegionDetection', 4, 'zone-1', NULL, '2026-06-09 04:00:00.000', 'NEW', 0, 80, '1.0', '{"event_code":"CrossRegionDetection","channel":4,"plate":null}', '["RG000000000000000000000004"]', NULL)
ON DUPLICATE KEY UPDATE state=VALUES(state), decision_reason=VALUES(decision_reason);

-- Demo: todas las alertas sin atender (solo ingesta en timeline).
