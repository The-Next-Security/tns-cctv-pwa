...
import { getUserDisplayName, getUserInitials } from '@/lib/user-avatar'
            ...
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center gap-2 px-1.5 sm:px-2 rounded-xl touch-target h-9 sm:h-10">
                ...
                <div className="hidden flex-col items-start text-left md:flex">
                  <span className="text-sm font-medium text-ds-ink-display antialiased">{getUserDisplayName(user)}</span>
